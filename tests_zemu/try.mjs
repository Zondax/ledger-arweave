...
const owner = 'get_your_owner_from_getAddress_command'

async function getFakeTx(enable_data, enable_tags) {
...
async function main() {
  ...
  const app = new ArweaveApp.default(transport);
  ...
  const signatureRequest = await app.sign(exampleData.transaction)

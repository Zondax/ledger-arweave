#ifndef GLYPH_digit_dot_BPP
        #define GLYPH_digit_dot_WIDTH 8
        #define GLYPH_digit_dot_HEIGHT 10
        #define GLYPH_digit_dot_BPP 1
extern unsigned int const C_digit_dot_colors[];
extern unsigned char const C_digit_dot_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_digit_dot;
...
extern unsigned char const C_icon_back_bitmap[];
        ...
        #endif // OS_IO_SEPROXYHAL
#ifndef GLYPH_icon_close_BPP
        #define GLYPH_icon_close_WIDTH 14
        #define GLYPH_icon_close_HEIGHT 14
        #define GLYPH_icon_close_BPP 1
extern unsigned int const C_icon_close_colors[];
extern unsigned char const C_icon_close_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_icon_close;
        #endif // GLYPH_icon_close_BPP
        #endif // OS_IO_SEPROXYHAL
...
extern unsigned char const C_icon_eye_bitmap[];
        ...
        #endif // OS_IO_SEPROXYHAL
#ifndef GLYPH_icon_validate_BPP
        #define GLYPH_icon_validate_WIDTH 12
        #define GLYPH_icon_validate_HEIGHT 8
        #define GLYPH_icon_validate_BPP 1
extern unsigned int const C_icon_validate_colors[];
extern unsigned char const C_icon_validate_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_icon_validate;
        #endif // GLYPH_icon_validate_BPP
        #endif // OS_IO_SEPROXYHAL

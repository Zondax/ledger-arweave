...
unsigned char const C_digit_dot_bitmap[] = {
  0x00, 0x00, 0x18, 0x3c, 0x66, 0x66, 0x3c, 0x18, 0x00, 0x00,
};
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_digit_dot = { GLYPH_digit_dot_WIDTH, GLYPH_digit_dot_HEIGHT, 1, C_digit_dot_colors, C_digit_dot_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
...
unsigned char const C_icon_app_bitmap[] = {
  0xff, 0xff, 0x07, 0xe0, 0xf3, 0xcf, 0x19, 0x9c, 0xfd, 0xbb, 0xfd, 0xbb, 0xfd, 0xbb, 0x1d, 0xb8,
  0xed, 0xbb, 0xed, 0xbb, 0xed, 0xbb, 0x1d, 0xb0, 0xf9, 0x9f, 0xf3, 0xcf, 0x07, 0xe0, 0xff, 0xff,
};
#ifdef HAVE_BAGL
        #include "bagl.h"
...
unsigned char const C_icon_back_bitmap[] = {
  ...
  0x1f, 0xe7, 0xe7, 0xf1, 0x3f, 0xf8, 0x07, 0x78, 0x00,
        ...
        #endif // HAVE_BAGL
#include "glyphs.h"
unsigned int const C_icon_close_colors[] = {
  0x00000000,
  0x00ffffff,
};

unsigned char const C_icon_close_bitmap[] = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x60, 0x18, 0x38, 0x07, 0xfc, 0x00, 0x1e, 0x80, 0x07, 0xf0, 0x03,
  0xce, 0x81, 0x61, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_icon_close = { GLYPH_icon_close_WIDTH, GLYPH_icon_close_HEIGHT, 1, C_icon_close_colors, C_icon_close_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
...
unsigned char const C_icon_validate_bitmap[] = {
  0x00, 0x02, 0x70, 0x84, 0xe3, 0x1c, 0xfc, 0x80, 0x07, 0x30, 0x00, 0x00,
};
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_icon_validate = { GLYPH_icon_validate_WIDTH, GLYPH_icon_validate_HEIGHT, 1, C_icon_validate_colors, C_icon_validate_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
